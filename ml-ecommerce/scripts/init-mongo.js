// ==========================================
// MongoDB Init Script
// Creates collections and indexes for event logs
// ==========================================
...
db.createCollection('user_events', {
  validator: {
    $jsonSchema: {
      bsonType: 'object',
      required: ['event_type', 'session_id', 'created_at'],
      properties: {
...
db.user_events.createIndex({ created_at: -1 }, { expireAfterSeconds: 15552000 }); // TTL: 180 days
...
db.recommendation_logs.createIndex({ strategy: 1 });

// Create search_logs collection
