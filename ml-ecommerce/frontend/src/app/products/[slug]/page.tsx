  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        ...
        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Product not found</h2>
        <Link href="/products" className="btn-primary btn-md mt-4 inline-flex">Browse Products</Link>
      </div>
    );
  }
